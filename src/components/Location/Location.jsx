...
const Location = () => {
  return (
    <div className='flex flex-col items-center'>
        <div className=''>
            <h1 className='text-center text-3xl font-bold mt-10 underline underline-offset-3 hover:drop-shadow-lg hover:drop-shadow-blue-200'>Location</h1>
        </div>
        
        <div className='w-11/12 flex flex-row justify-around flex-wrap '>
            {Data.map((item)=>{return(
                <div className='w-96 h-auto bg-blue-400/60 my-10 m-2  flex flex-col items-center rounded-lg hover:scale-105 hover:transition hover:delay-200'>
